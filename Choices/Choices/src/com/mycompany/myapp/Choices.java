...
//        ComboBox<Map<String, Object>> stateCombo = new ComboBox<> (
        ...
        /*
         * while (true) { TimeUnit.SECONDS.sleep(0.5); if
         * ((!firstName.getText().equals("") && !stateName.getText().equals("")
         * && !genderName.getText().equals("") &&
         * !raceName.getText().equals(""))) { submit.setHidden(false); } else {
